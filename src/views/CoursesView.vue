    ...
    <div class="column is-multiline">
        ...
        <div class="container box">
            <nav class="pagination" role="navigation" aria-label="pagination">
                ...
                <ul class="pagination-list" v-if="current_page_number ==1">
                    <li>
                ...
                <ul class="pagination-list" v-else-if="current_page_number != '1'">
            ...
            <table>
                    <tr>
                        <th class="has-text-centered is-size-4">#</th>
                        ...
                        <th class="has-text-centered is-size-4">Направление</th>
                    </tr>
                    <tr v-for="course in cdoCourses" v-bind:key="course.results">
                        <th class="has-text-left has-text-weight-light pl-1 is-size-4"> {{ course.id }}</th>
                        ...
                        <th class="has-text-left has-text-weight-light pl-1 is-size-4"> {{ course.area }}</th>
              </tr>
                </table>
        </div>
    </div>
