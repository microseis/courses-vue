                ...
                <form @submit.prevent="submitForm">
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <br>
                            или <router-link to="/log-in">войдите</router-link>, если у вас уже есть аккаунт
                        </div>
                    </div>
                </form>
            </div>
...
export default {
  ...
  mounted () {
    document.title = 'Регистрация пользователя | CdoGEO'
  },
  methods: {
    submitForm () {
      this.errors = []
      ...
      if (!this.errors.length) {
        ...
        axios
          ...
          .then(response => {
            toast({
              message: 'Аккаунт создан, вы можете войти в него',
              type: 'is-success',
              dismissible: true,
              pauseOnHover: true,
              duration: 2000,
